...
model = pickle.load(open('PD.pkl', 'rb'))
...
def predict():
    ...
    if request.method == 'POST':
        ...
        # loanterm -15days, 30days, 60days, 90days (90 days is the reference category).
        ...
        # Bank_account_type
        # Savings, Other, Current. (Current is the reference category)
        ...
        # Employment_status.
        # Employed, Others, Self-Employed, Student. (Others is the ref category)
        ...
        features = [[age, loanamount, loannumber, termdays_15, termdays_30, termdays_60, bank_account_type_Other,
                     bank_account_type_Savings, employment_status_clients_Employed, employment_status_clients_Self_Employed, 
                     employment_status_clients_Student, age_per_loannumber, amount_per_loannumber, age_per_loanamount, employed_other, 
                     age_employed, age_other]]
